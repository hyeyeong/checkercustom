    ...
    for (int i = 0; i < epack.getManifest().itemsLength(); i++)
    {
      ...
      if (vtsd.isValidMediaType(mi.getMediaType()))
      {
        ...
        {*/
          ...
          */
          if (xmlLangAttribute == null && langAttribute == null)
          { 
        	  report.message(MessageId.KEAT_004, EPUBLocation.create(fileToParse));
        	  report.message(MessageId.KEAT_007, EPUBLocation.create(fileToParse));
        	  //report.message(MessageId.KEAT_008, EPUBLocation.create(fileToParse));
          }
        //}
      }
    }
