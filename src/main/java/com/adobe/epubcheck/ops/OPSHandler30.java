...
public class OPSHandler30 extends OPSHandler
{
  ...
  protected int figureDepth = 0;
  protected boolean hasNotfigcaption = false;
  protected boolean hasNoPrevfigcaption = false;
  protected boolean hasNoNextfigcaption = false;
  protected boolean hasFigcaption = false;
  protected String prevFigcaptionTagName = null;
  ...
  public void startElement()
  {
    ...
    if (figureDepth > 0 && !name.equals("figcaption"))
    {
    	hasNotfigcaption = true;
    	prevFigcaptionTagName = name;
    }
    else if (figureDepth > 0 && name.equals("figcaption"))
    {
    	if (hasNotfigcaption)
    	{
    		//report.message(MessageId.KEAT_029, parser.getLocation());
    	}
    	
    	hasFigcaption = true;
    }
    
    if (figureDepth > 0 && !name.equals("figcaption") && !hasFigcaption)
    {
    	hasNoPrevfigcaption = true;
    	
    	if (name.equals("table") && null != e.getAttribute("caption"))
    	{
    		//report.message(MessageId.KEAT_030, parser.getLocation());
    	}
    }
    
    if (figureDepth > 0 && !name.equals("figcaption")  && hasFigcaption)
    {
    	hasNoNextfigcaption = true;
    }
  ...
  public void endElement()
  {
    ...
    else if (name.equals("figure"))
    {
    	if (hasFigcaption)
    	{
    		if (hasNoPrevfigcaption && hasNoNextfigcaption)
    		{
    			report.message(MessageId.KEAT_029, parser.getLocation());
    		}
    		/*
    		if (prevFigcaptionTagName != null && !prevFigcaptionTagName.equals("figcaption"))
    		{
    			report.message(MessageId.KEAT_029, parser.getLocation());
    		}
    		*/
    	...
    	--figureDepth;
    	hasFigcaption = false;
    	hasNoPrevfigcaption = false;
    	hasNoNextfigcaption = false;
    	hasNotfigcaption = false;
    }
  }
